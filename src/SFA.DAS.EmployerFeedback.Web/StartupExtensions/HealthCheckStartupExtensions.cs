...
using SFA.DAS.EmployerFeedback.Web.HealthChecks;
...
namespace SFA.DAS.EmployerFeedback.Web.StartupExtensions
{
    ...
    {
        public static IServiceCollection AddDasHealthChecks(this IServiceCollection services, EmployerFeedbackWebConfiguration configWeb)
        {
            services
                .AddHealthChecks()
