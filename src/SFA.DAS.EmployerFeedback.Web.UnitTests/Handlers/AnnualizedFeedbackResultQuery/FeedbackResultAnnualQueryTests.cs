...
namespace UnitTests.Api
{
    public class FeedbackResultAnnualQueryTests
    {
        ...
        private Mock<IEmployerFeedbackOuterApi> employerFeedbackOuterApiMock;
        ...
        public void Setup()
        {
            ...
            handler = new FeedbackResultAnnualQueryHandler(employerFeedbackOuterApiMock.Object, mockLogger.Object);
        }
        ...
        public async Task WhenQueryingFeedbackResultAnnual_IfNullReturnsEmptyCollection()
        {
            ...
            // Arrange
            employerFeedbackOuterApiMock.Setup(s => s.GetFeedbackResultSummaryAnnual(123))
        ...
        {
            // Arrange
            employerFeedbackOuterApiMock.Setup(s => s.GetFeedbackResultSummaryAnnual(456))
        ...
        public async Task WhenQueryingFeedbackResultAnnual_IfFeedbackExistsReturnsConvertedModel()
        {
            ...
            employerFeedbackOuterApiMock.Setup(s => s.GetFeedbackResultSummaryAnnual(789))
